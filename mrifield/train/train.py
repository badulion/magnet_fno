...
input_normalizer = arcsinhStandardNormalizer.load_from_json(f"{TRAIN_DIR}/normalization/input_normalization.json")
...
wandb_logger = WandbLogger(project="fno", name="16M - 16M, 42H, IHS")
